package com.quandz.krakenmobcoins.shops.loader;
...
public class ItemsLoader {
    ...
    public void loadMainMenu() {
        ...
        ConfigurationSection section = config.getConfigurationSection("normaShop.items");
    ...
    public void loadRotatingItems() {
        FileConfiguration config = plugin.getConfig();
        ConfigurationSection section = config.getConfigurationSection("rotatingShop.items");
        if (section == null) return;
        section.getKeys(false).forEach((key) -> {
    ...
    public void loadShopItems() {
        ...
        ConfigurationSection section = shop.getConfigurationSection("shops");
        if (section == null) return;
        section.getKeys(false).forEach((key) -> {
